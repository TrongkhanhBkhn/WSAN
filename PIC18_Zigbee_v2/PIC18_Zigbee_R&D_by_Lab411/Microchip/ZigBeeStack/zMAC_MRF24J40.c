...
#if defined(__C30__)
	#include <string.h>
	//these definition are defined by lab411 @dat_a3cbq91
	#define GROUP_INDICATION			LATAbits.LATA10
	#define MESSAGE_INDICATION			LATAbits.LATA7
#endif
#ifdef USE_ZCP_DEBUG//This condition is made by lab411 @dat_a3cbq91
	#include "Console.h"
	#define ZCP_DEBUG//by lab411 @dat_a3cbq91
	#define ZCP_PRINTOUT//by lab411 @dat_a3cbq91
#endif
...
#endif
                            SendTxBuffer : { //need this bracket for the #ifdef with the hanging else
