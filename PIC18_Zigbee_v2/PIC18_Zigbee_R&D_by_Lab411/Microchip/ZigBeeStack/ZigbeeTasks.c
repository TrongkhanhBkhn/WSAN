...
#if defined(__C30__)	//This is added by lab411 @dat_a3cbq91
	#define GROUP_INDICATION			LATAbits.LATA10
	#define MESSAGE_INDICATION			LATAbits.LATA7
#include "Console.h"
#endif	//This is added by lab411 @dat_a3cbq91
...
void ZigBeeInit(void)
{
    ...
    // Set up the interrupt to read in a data packet.
        ...
        RFIE = 1;
    #endif
    InitSymbolTimer();//use Timer0 - dat_a3cbq91
...
BOOL ZigBeeTasks( ZIGBEE_PRIMITIVE *command )
{
    ...
    do        /* need to determine/modify the exit conditions */
    {
        ...
        switch(ZigBeeStatus.nextZigBeeState)
        {
            ...
            case MLME_POLL_request://1 thiet bi yeu cau du lieu trong coordinator khi duoc thong bao co du lieu cho no.
								   //This comment written by lab411 @dat_a3cbq91
                ZigBeeStatus.nextZigBeeState = MACTasks(ZigBeeStatus.nextZigBeeState);
                break;
