...
#include "zAPS.h"
...
#if defined(__18F26K20) && !defined(USE_EXTERNAL_NVM)//target device is modified by lab411 @dat_a3cbq91
    ...
    /*  If you are storing your nonvolatile memory internally and you are using
        a device other than the PIC18F26K20, it may have different erase and
    ...
    #define ERASE_BLOCK_SIZE        (64ul)	//these define by lab411 @dat_a3cbq91
    #define WRITE_BLOCK_SIZE        (64ul)
#endif
