...
#define TESTZCP_PROFILE_ID                  0x7f01
...
#define PROFILE_MinRouteDiscoveryTableSize      2	//in microchip source code, this has value is 4 (lab411 @dat_a3cbq91)
...
/* Clusters is added by WSAN-Group Lab411 @dat_a3cbq91 */
#define CONFIRM_JOIN_NETWORK_CLUSTER                            0x0005  // Manage joining into network of nodes
#define NOTICE_STATE_NODE_CLUSTER                               0x0006  // Monitor state of nodes in network
#define ACTOR_REQUEST_CLUSTER                                   0x0007  // Receive command from Gateway and control actor
#define ACTOR_RESPONSE_CLUSTER                                  0x0008  // Confirm to Gateway
#define HTE_DATA_REQUEST_CLUSTER                                0x0009  // Receive command from Gateway and get data humi - temp - energy
#define HTE_DATA_RESPONSE_CLUSTER                               0x000A  // Send data humi - temp - energy to Gateway
/* End by WSAN-Group Lab411 @dat_a3cbq91 */
...
#define FREEFORM_MSG_REQUEST_CLUSTER				0xa0A8	//Freeform MSG request//this command is commented by lab411 @dat_a3cbq91
#define MANAGE_TIME_ATTRIBUTES_CLUSTER				0x00C4	//Manage time atributes
#define FREEFORM_MSG_RESPONSE_CLUSTER				0xe000	//Freeform MSG response//this command is commented by lab411 @dat_a3cbq91
#define MANAGE_STRING_ATTRIBUTES_CLUSTER			0x00FF	//Manage string attributes
#define REVERSE_FREEFORM_MSG_RESPONSE_CLUSTER                   0x00e0  //Reverse Freeform MSG response//this command is commented by lab411 @dat_a3cbq91
