...
//    #define SYMBOLS_TO_TICKS(a) ((CLOCK_FREQ/1000 * a) / (SYMBOL_TO_TICK_RATE / 1000))
    #define SYMBOLS_TO_TICKS(a) (((((CLOCK_FREQ * 10ul) + (5ul * SYMBOL_TO_TICK_RATE))/SYMBOL_TO_TICK_RATE)*a)/10ul)
            ...
            #define SYMBOL_TO_TICK_RATE 16000000 //Microchip: 32000000 @dat_a3cbq91
        #endif
...
#define ONE_MILI_SECOND     (ONE_SECOND/1000)//Define by lab411 @dat_a3cbq91
#define HUNDRED_MILI_SECOND (ONE_SECOND/10)//Define by lab411 @dat_a3cbq91
#define FORTY_MILI_SECOND   (ONE_SECOND/25)//Define by lab411 @dat_a3cbq91
#define TWENTY_MILI_SECOND  (ONE_SECOND/50)//Define by lab411 @dat_a3cbq91
#define TEN_MILI_SECOND     (ONE_SECOND/100)//Define by lab411 @dat_a3cbq91
#define FIVE_MILI_SECOND    (ONE_SECOND/200)//Define by lab411 @dat_a3cbq91
#define TWO_MILI_SECOND     (ONE_SECOND/500)//Define by lab411 @dat_a3cbq91
