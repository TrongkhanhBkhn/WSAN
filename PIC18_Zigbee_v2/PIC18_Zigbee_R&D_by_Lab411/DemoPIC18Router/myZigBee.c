...
// Created by ZENA(TM) Version 3.0.0.0, 5/22/2011, 21:36:49
...
,
	{
        ...
        { 
            ...
            HTE_DATA_REQUEST_CLUSTER
        }, 
        4,
        { 
            CONFIRM_JOIN_NETWORK_CLUSTER,
            NOTICE_STATE_NODE_CLUSTER,
            ACTOR_RESPONSE_CLUSTER,
            HTE_DATA_RESPONSE_CLUSTER
        } 
    }
,
	{
